...
def new_connection(tid, host, port):
    ...
    try:
       message = "Hello from {}".format(tid)
       client_socket.sendto(message.encode(), (host, port))
    except Exception as e:
       print('Exception in UDP sendto! Demo ended unexpectedly!!!')
       print(str(e))
       client_socket.close()
       return
    finally:
...
def start_udp_client(threadnum, host, port):
...
if __name__ == "__main__":
    ...
    start_udp_client(cnum, host, port)